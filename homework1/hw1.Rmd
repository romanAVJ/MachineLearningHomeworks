...
subtitle: Román Alverto Vélez Jiménez CU 165462,
          Iván Alvarez Tostado CU 167699  
output:
  html_document:
    df_print: paged
---
...
Finalmente, reduciremos el número de variables independientes a 3 y 2 variables en el set de entrenamiento para ver el desempeño del algoritmo en cada caso

```{r}
#Testing data reduction
test_three <- test_data[,-sample(1:4, 1)]
test_two <- test_three[,-sample(1:3, 1)]
